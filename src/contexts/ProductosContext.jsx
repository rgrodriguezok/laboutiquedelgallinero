...
export function ProductosProvider({ children }) {
    ...
    function editarProducto(producto) {
        return (
            new Promise(async (res, rej) => {
                try {
                    const respuesta = await fetch(`https://68221963b342dce8004d1cdf.mockapi.io/productos/${producto.id}`, {
                        method: 'PUT',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    const eliminarProducto = (id) => {
        ...
        if (confirmar) {
            return (
                new Promise(async (res, rej) => {
                    try {
                        const respuesta = await fetch(`https://68221963b342dce8004d1cdf.mockapi.io/productos/${id}`, {
                            method: 'DELETE',
                        });
